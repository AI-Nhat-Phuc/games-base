...
async function buildCharacterCommand(options: BuildCharacterOptions) {
  console.log(chalk.cyan(`\n🎨 Building character: ${chalk.bold(options.name)}\n`));
  ...
  try {
    ...
    console.log(chalk.white(`  📄 ${path.relative(process.cwd(), outputFile)}`));
    console.log(chalk.white(`  📄 ${path.relative(process.cwd(), tsFile)}`));
    console.log();
...
import { GameManager } from '@pnp/game-core-client';
