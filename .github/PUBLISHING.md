...
- **Install**: `npm install @nhatphucpham/game-core-client` (gets latest version)
...
- **Install**: `npm install @nhatphucpham/game-core-client@1.0.0-beta-pr-123.20241101120000`
...
**Example**: If `base/package.json` has version `1.2.0`, it publishes `@nhatphucpham/game-core-client@1.2.0` with tag `latest`.
...
**Example**: PR #123 with `base/package.json` version `1.2.0` publishes as `@nhatphucpham/game-core-client@1.2.0-beta-pr-123.20241101120530` with tag `beta`.
...
npm install @nhatphucpham/game-core-client@1.0.0-beta-pr-45.20241101153025
...
4. **Automatic**: Publishes `@nhatphucpham/game-core-client@1.0.0-beta-pr-45.{timestamp}` with tag `beta`
5. Test beta version in other projects
6. Merge to main after approval
7. **Automatic**: Publishes `@nhatphucpham/game-core-client@1.0.0` with tag `latest`

### Scenario 2: Bug Fix
1. Update version: `cd base && npm version patch` (1.0.0 → 1.0.1)
2. Commit: `git commit -m "Fix character collision bug"`
3. Push to main: `git push origin main`
4. **Automatic**: Publishes `@nhatphucpham/game-core-client@1.0.1` with tag `latest`
...
- Scoped packages (`@nhatphucpham/...`) require organization membership
...
3. **Test beta versions before production:**
   ...
   - Install and test: `npm install @nhatphucpham/game-core-client@beta`
...
- Ensure `@nhatphucpham` organization exists on NPM
